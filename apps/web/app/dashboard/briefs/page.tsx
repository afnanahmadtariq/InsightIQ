...
import { EmptyState, PrimaryAction, StatusBadge, WorkspaceHeader, WorkspacePage, WorkspaceSection } from '../../../components/workspace-ui'
...
export default async function Page() {
  ...
  return <WorkspacePage>
    <WorkspaceHeader eyebrow="Deal briefs" title="From evidence to action." lead="Meeting preparation and outreach drafts belong here only after every supporting claim can point back to a public source." action={<PrimaryAction href="/dashboard/research/new"><Plus size={17}/>New research run</PrimaryAction>}/>
